...
import kotlinx.android.synthetic.main.single_player_details_layout.*
import net.rmitsolutions.mfexpert.lms.helpers.switchToFragment
import net.rmitsolutions.mfexpert.lms.helpers.toast
import org.jetbrains.anko.find

class SinglePlayDetails : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_single_play_details, container, false)

...
import com.example.mayank.kwizzapp.databinding.EditBankDetailsBinding
...
class EditBankDetailsFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var userInfoVm: Users.UserBankDetails
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        userInfoVm = Users.UserBankDetails()
